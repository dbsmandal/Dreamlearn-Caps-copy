...
const CourseList = () => {
    ...
    return (
        <div className="">
            <h3 className='text-center mt-10 text-2xl font-semibold text-purple-900 underline underline-offset-2 mb-10'>My Course List </h3>
                ...
                (courseList.map((data) => {
                    ...
                    return (
                        <div key={id} className="grid grid-cols-11 gap-1  mt-5 m-3 p-2 border shadow-sm rounded-md shadow-purple-500" >
                         ...
                         >  <button  className="border  p-1 mt-3 text-lg rounded-lg bg-purple-900 text-white  m-auto focus:outline-none focus:shadow-outline">Scheduled {console.log(title)}</button></Link>
                           </div>
                        </div>
